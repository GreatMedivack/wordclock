...
GRID = [
    "РДВАДЦАТЬЗПЯТЬЧЖ",  #  0: ДВАДЦАТЬ _ ПЯТЬ_M
    "ФЭДЕСЯТЬЫМИНУТКЩ",  #  1: ДЕСЯТЬ_M _ МИНУТ
    "ЧЕТВЕРТЬПОЛОВИНА",  #  2: ЧЕТВЕРТЬ ПОЛОВИНА
    "ЮБЕЗЛДВАДЦАТИМУП",  #  3: БЕЗ _ ДВАДЦАТИ
    "ПЯТИХЧЕТВЕРТИШЦЪ",  #  4: ПЯТИ _ ЧЕТВЕРТИ
    "ДЕСЯТИПЕРВОГОТРИ",  #  5: ДЕСЯТИ ПЕРВОГО ТРИ
    "ВТОРОГОПЯТОГОЧАС",  #  6: ВТОРОГО ПЯТОГО ЧАС
    "ТРЕТЬЕГОШЕСТОГОБ",  #  7: ТРЕТЬЕГО ШЕСТОГО
