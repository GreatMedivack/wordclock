...
//  0: РДВАДЦАТЬЗПЯТЬЧЖ   ДВАДЦАТЬ _ ПЯТЬ_M
//  1: ФЭДЕСЯТЬЫМИНУТКЩ   ДЕСЯТЬ_M _ МИНУТ
//  2: ЧЕТВЕРТЬПОЛОВИНА   ЧЕТВЕРТЬ ПОЛОВИНА
//  3: ЮБЕЗЛДВАДЦАТИМУП   БЕЗ _ ДВАДЦАТИ
//  4: ПЯТИХЧЕТВЕРТИШЦЪ   ПЯТИ _ ЧЕТВЕРТИ
//  5: ДЕСЯТИПЕРВОГОТРИ   ДЕСЯТИ ПЕРВОГО ТРИ
//  6: ВТОРОГОПЯТОГОЧАС   ВТОРОГО ПЯТОГО ЧАС
//  7: ТРЕТЬЕГОШЕСТОГОБ   ТРЕТЬЕГО ШЕСТОГО
